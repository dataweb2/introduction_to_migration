...
The Drupal setup used in this session was an 'out-of-the-box' Drupal 11 install with contribute module (`migrate_plus`)[https://www.drupal.org/project/migrate_plus] and (`migrate_tools`)[https://www.drupal.org/project/migrate_tools] installed and enabled.
